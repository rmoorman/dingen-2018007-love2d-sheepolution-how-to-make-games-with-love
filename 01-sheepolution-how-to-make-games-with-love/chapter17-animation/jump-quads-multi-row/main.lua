function love.load()
  image = love.graphics.newImage("media/jump_2.png")
  ...
  for i = 0, 1 do -- loop through the rows we have
    for j = 0, 2 do -- loop throught the columns we have
      table.insert(frames, love.graphics.newQuad(j * frame_width, i * frame_height, frame_width, frame_height, source_width, source_height))
